         ...
         <div class="section" id="detail-page">
            <div class="section-detail">
               <form method="POST" action="pages/change_banner_perform.php" enctype="multipart/form-data">
                  ...
                  <input type="text" name="title1" id="title1" value="<?php echo $row["title1"];?>">
                  <label for="title">Tiêu đề 2</label>
                  <input type="text" name="title2" id="title2" value="<?php echo $row["title2"];?>">
                  <label for="title">Tiêu đề 3</label>
                  <input type="text" name="title3" id="title3" value="<?php echo $row["title3"];?>">
