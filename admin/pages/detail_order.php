...
<body>
    ...
    <div id="main-content-wp" class="list-product-page">
        ...
        <div id="printablediv">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    while ($row1 = mysqli_fetch_array($run1)) {
                                        ...
                                        $sql2 = "select * from tbl_product where id = " . $row1['productid'];
                                        ...
                                        <tr>
                                            ...
                                            <td class="thead-text"><?php $tongsoluong += $row1["quantity"];
                                                                                echo $row1["quantity"]; ?></td>
                                            <td class="thead-text"><?php echo (number_format($row1["price"] * $row1["quantity"])) ?> VNĐ</td>
                                        </tr>
                                <?php }
                                    } ?>
                            </tbody>
                    ...
                    <div class="section-detail">
                        <ul class="list-item clearfix">
                            ...
                            <li>
                                ...
                                <span class="total"><?php echo number_format($row['amount']); ?> VNĐ</span>
                            </li>
                        <?php } ?>
                        </ul>
                    </div>
                ...
                <button type="submit" onclick="javascript:printDiv('printablediv')" name="print">Print</button>
