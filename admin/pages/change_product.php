            ...
            <div class="section-detail">
               <form method="POST" action="pages/change_product_perform.php" enctype="multipart/form-data">
                  ...
                  for($count=0;$count<count($row_product_detail);$count++) {
                     ...
                     <input type="text" name="size[]" id="size" value="'.$row_product_detail[$count][1].'">
                     <label for="color">Màu</label>
                     <input type="text" name="color[]" id="color" value="'.$row_product_detail[$count][2].'">
                     <label for="amount">Số lượng</label>
                     <input type="text" name="amount[]" id="amount" value="'.$row_product_detail[$count][3].'">
                     ';
                  }
