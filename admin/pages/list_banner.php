<div id="main-content-wp" class="list-product-page">
    <div class="section" id="title-page">
        <div class="clearfix">
            <!-- <a href="?page=add_banner" title="" id="add-new" class="fl-left">Thêm mới</a> -->
            <h3 id="index" class="fl-left" style="margin-left: 30px">Danh sách banner</h3>
        </div>
    </div>
                        ...
                        <table class="table list-table-wp">
                            <thead>
                                <tr>
                                    ...
                                    <td><span class="thead-text">Tiêu đề 1</span></td>
                                    <td><span class="thead-text">Tiêu đề 2</span></td>
                                    <td><span class="thead-text">Tiêu đề 3</span></td>
                            ...
                            <tbody>
                              ...
                              //Bước 2: Hiển thị các dữ liệu trong bảng ra đây
                                ...
                                <tr>
                                    ...
                                    <td><span class="tbody-text"><?php echo $row["title1"];?></h3></span>
                                    <td><span class="tbody-text"><?php echo $row["title2"];?></h3></span>
                                    <td><span class="tbody-text"><?php echo $row["title3"];?></h3></span>
                                    <td>
