            ...
            <div class="container">
                ...
                <div class="privacy-policy-page">
                    <div class="privacy-policy-page-content">
                        ...
                        <p><strong>Information that is gathered from visitors: </strong></p>
                        <p>In common with other websites, log files are stored on the web server saving details such as the visitor's IP address, browser type, referring page and time of visit.</p>
                        <p>Cookies may be used to remember visitor preferences when interacting with the website.
                        <br>Where registration is required, the visitor's email and a username will be stored on the server.</p>    
                        <br><br>
                        ...
                        <p>You may be able to block cookies via your browser settings but this may prevent you from access to certain features of the website. </p><br><br>
