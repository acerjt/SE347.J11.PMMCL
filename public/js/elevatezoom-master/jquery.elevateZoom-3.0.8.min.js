...
(function(d, h, l, m) {
    var k = {
        ...
        startZoom: function() {
            ...
            b.zoomContainer = d('<div class="zoomContainer" style="-webkit-transform: translateZ(0);position:absolute;left:' + 350.5 + "px;top:" + 246.433 + "px;height:" + b.nzHeight + "px;width:" + b.nzWidth + 'px;"></div>');
