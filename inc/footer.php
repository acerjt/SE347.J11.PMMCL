                    ...
                    <div class="twitter-feed">
                        <div class="twitter-article">
                            <div class="twitter-img">
                                <a href="#">
                                    <img src="public/img/twitter/twitter-1.png" alt="">
                                </a>
                            </div>
                ...
                <div class="footer-support">
                    ...
                    <div class="footer-menu">
                        <ul>
                            ...
                            <li><a href="?page=your-account">Your Account</a></li>
                            <li><a href="?page=advance-search">Advanced Search</a></li>
                ...
                <div class="footer-info">
                    ...
                    <div class="footer-menu">
                        <ul>
                            ...
                            <li><a href="?page=orders-returns">Orders and Returns</a></li>
                            <li><a href="?page=will-love">Will love</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-product">
                        <div class="product-images">
                            <div class="main-image images">
                                <img alt="" src="public/img/product/quick-view.jpg">
                            </div>
                        </div>
